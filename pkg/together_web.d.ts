...
export interface InitOutput {
    ...
    readonly __wasm_bindgen_func_elem_20640: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_20642: (a: number, b: number, c: number, d: number) => void;
    readonly __wasm_bindgen_func_elem_10506: (a: number, b: number, c: number) => void;
    ...
    readonly __wasm_bindgen_func_elem_7924: (a: number, b: number, c: number) => void;
    readonly __wasm_bindgen_func_elem_10301: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_11407: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_11488: (a: number, b: number) => void;
    readonly __wasm_bindgen_func_elem_20479: (a: number, b: number) => void;
